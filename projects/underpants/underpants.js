...
_.first = function(array, num){
    ...
    else if(num === undefined || isNaN(num) === true){
        return array[0];
    }
...
_.partition = function(array, func){
    ...
    bothArrays.push(truArray, falArray);
    return bothArrays;
};
...
_.pluck = function(arrayObj, property){
    ...
    return _.map(arrayObj, function(e, i, c){
        return e[property];
...
_.some = function(collection, func){
    let mappedOutput = _.map(collection, function(e, i, c){
        if(func === undefined){
            if(e){
                return true;
            }
    ...
    for(let i = 0; i < mappedOutput.length; i ++){
        if(mappedOutput[i]){
            return true;
        }
...
_.extend = function(obj, ...objs){
    //console.log(objs);
    //console.log(obj);
    _.each(objs, function(objects, i, c){
