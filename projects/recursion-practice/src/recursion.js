...
var reverse = function(string) {
  ...
  return string === '' ? '' : reverse(string.substr(1)) + string[0];
};
...
var palindrome = function(string) {
  ...
  else if(str[0] !== str.slice(-1).toLowerCase()){
    return false;
  }
...
var createArray = function(str){
  ...
  myArray.push(str[0]);
  myArray = myArray.concat(createArray(str.slice(1)));
  return myArray;
};
...
var reverseArr = function (array) {
  ...
  if(array.length === 0){
    ...
    reveresed.push(array.pop());
    reveresed = reveresed.concat(reverseArr(array.slice(0)));
    return reveresed;
};
...
var capitalizeWords = function(input) {
  ...
  cap = cap.concat(capitalizeWords(input.slice(1)));
  return cap;
};
...
var capitalizeFirst = function(array) {
  ...
  cap = cap.concat(capitalizeFirst(array.slice(1)));
  return cap;
};
...
var numToText = function(str) {
  ...
  for(let number in numWord){
    if(number === str[0]){
      str.split('');
      str[0] = numWord[number];
      str = str.join('')
    }
  }
